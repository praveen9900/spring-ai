...
public class TaskManagementTools {
    ...
    public TaskResult createTask(String title, String description, String assignee) {
        ...
        return new TaskResult(taskId, title, "PENDING", assignee, "Task created successfully and assigned to " + assignee);
    }
    ...
    public TaskResult updateStatus(Long taskId, TaskStatus status) {
        ...
        return new TaskResult(taskId, updatedTask.title(), status.toString(), updatedTask.assignee(), "Task status updated to " + status);
    }
